...
export class UniverseComponent implements OnInit, AfterViewInit {
  ...
  @ViewChild(ControlDirective) controls: ControlDirective;
  ...
  @ContentChildren(BoxThreeComponent) boxes: QueryList<BoxThreeComponent>;
  ...
  private initializeScenes() {
   ...
   // this.controls.camera = this.camera;
     if(this.controls == null && this.controls === undefined){
       this.controls = new ControlDirective();
       this.controls.camera = this.camera;
     }
  }
